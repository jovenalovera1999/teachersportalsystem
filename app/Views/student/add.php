...
<title>Teacher's Portal | Add Student</title>
        ...
        <div id="content" class="p-4 p-md-5 pt-5">
                    ...
                    <div class="toast-container top-0 end-0 p-3">
                        <div class="toast bg-danger text-white" role="alert" aria-live="assertive" aria-atomic="true">
                            <div class="toast-body">
                                ...
                                <strong class="me-auto">Failed to add!</strong>
            ...
            <div class="container">
                <div class="card-body w-75 mx-auto">
                    ...
                    <!-- Form login -->
                    <form class="mt-5" action="<?=base_url()?>student/add" method="post">
                        <div class="row">
                            <div class="col">
                                <div class="mb-3">
                        ...
                        <button type="submit" class="btn w-100" id="custom-button-color">Add</button>
